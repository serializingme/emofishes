...
int main() {
    ...
    print_header(L"Nofish", L"Nosey fish", L"Directory and file listings of all\nlogical drives.", 10);

    wprintf(L"[*] Initializing log file ... ");
    if (open_log("nofish.log") != 1) {
        print_failed();
    } else print_ok();

    write_log(L"nofish", L"Start");
